...
export function MultiTagSelect<Id extends number | string>({
  ...
  return (
    <div className={cn("relative min-w-0", className)} ref={rootRef}>
      ...
      {open && (
        <div className="absolute left-0 top-[calc(100%+0.375rem)] z-50 grid w-full min-w-72 gap-2 rounded-md border border-border/80 bg-popover p-2 text-popover-foreground shadow-[0_10px_28px_-22px_rgb(0_0_0/0.45)]">
