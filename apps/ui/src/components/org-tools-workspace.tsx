...
import { BrowserFileSwitcher } from "@/components/browser-file-switcher";
...
export const OrgToolsWorkspace = observer(() => {
  ...
  return (
    <>
            ...
            >
              ...
              <div className="relative ml-auto flex shrink-0 items-center">
                ...
                <Button
                  ...
                  disabled={!workspace.dirty || workspace.saveStatus === "saving"}
      ...
      {workspace.mode === "sqlite" && workspace.notice === "link-copied" && (
        <div
