...
export const normalizeEmployeeIdentityPart = (value: string | null | undefined): string =>
...
export const createEmployeeIdentityKey = (fields: EmployeeIdentityFields): string =>
