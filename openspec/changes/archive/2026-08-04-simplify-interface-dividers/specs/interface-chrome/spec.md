...
The application SHALL use spacing, background grouping, and control layout instead of decorative
horizontal rules in the main shell, status bands, product surface headers, and local section
headers.

#### Scenario: Populated product surface
- **WHEN** a populated product surface renders below the app header and tab navigation
- **THEN** shell and surface sections remain visually ordered without horizontal divider lines
