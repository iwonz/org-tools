...
**Reason**: Locale is now part of the complete durable UI projection and state transfer contract.

**Migration**: Keep local storage only as initial bootstrap metadata and make loaded state
authoritative.
