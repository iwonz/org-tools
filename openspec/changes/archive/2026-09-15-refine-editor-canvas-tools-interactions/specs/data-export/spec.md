...
Data Download, Editor Template export, full-View Editor Image Employee format, and custom Employee Template definitions SHALL use one shared multiline Format input and SHALL NOT render separate
