...
shared full-spectrum picker directly from the row and SHALL persist one valid color change per
completed interaction. Deleting a definition SHALL atomically remove its assignments, filters, and
output exclusions.
